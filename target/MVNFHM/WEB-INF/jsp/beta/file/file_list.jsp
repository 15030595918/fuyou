...
<body class="no-skin">
							...
							<tr>
								...
								<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入题名" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入题名"/>
												...
												<%--<div class="hidden-md hidden-lg">--%>
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<%--<c:if test="${QX.edit == 1 }">--%>
																<%--<a style="cursor:pointer;" href="attachment/list.do?FILE_ID=${var.ID}" class="tooltip-yellow" data-rel="tooltip" title="附件">--%>
																	<%--<span class="yellow">--%>
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>file/excel.do?keywords=${pd.keywords}';
		}


		function openPdf(VOLUME_NUM,FILE_SN) {

			window.open('<%=basePath%>file/findByNum.do?VOLUME_NUM=' + VOLUME_NUM + '&FILE_SN=' + FILE_SN);

//            var url="/uploadFiles/uploadFile/"+	VOLUME_NUM + ".pdf";
