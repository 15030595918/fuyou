...
import com.beta.service.rolling.impl.AttachmentService;
...
//		fileService.findNameById(pd);
//		attachmentService.findIdByName(pd);
		page.setPd(pd);
		List<PageData>	varList = attachmentService.list(page);	//列出Attachment列表
		mv.setViewName("beta/attachment/attachment_list");
	...
	public ModelAndView goAdd(Page page)throws Exception{
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData>	fileList = fileService.listF(page);
		mv.setViewName("beta/attachment/attachment_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var8", varOList.get(i).get("FILE_ID").toString());	//8
			varList.add(vpd);
		}
