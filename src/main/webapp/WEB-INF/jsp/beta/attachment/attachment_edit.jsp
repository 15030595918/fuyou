		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="attachment/${msg }.do" onsubmit="return valid()" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<%--<tr>--%>
								...
								<%--<td><input type="number"  name="FILE_ID" id="FILE_ID" value="${pd.FILE_ID}" maxlength="32" placeholder="这里输入备注8" title="备注8" style="width:98%;"/></td>--%>
							<%--</tr>--%>
								<tr>
									<td style="width:79px;text-align: right;padding-top: 13px;">文件题名:</td>
									<td id="file">
										<select <c:if test="${not empty pd.FILE_ID}">disabled</c:if> class="chosen-select form-control" name="FILE_ID" id="FILE_ID"  data-placeholder="请选择文件" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
											<c:forEach items="${fileList}" var="file">
												<option value="${file.FILE_ID }" <c:if test="${file.FILE_ID == pd.FILE_ID }">selected</c:if>>${file.FILE_NAME }</option>
											</c:forEach>
										</select>
